            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Ubah Data Guru</div>
                    </div>
                    <div class="card-body">
                        <form action="/admin-guru-ubah-data/<?= $guru['id_guru']; ?>" method="POST" id="formInput" autocomplete="off">
                            <?= csrf_field() ?>
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group <?= ($validation->hasError('alamat') ? 'has-error has-feedback' : ''); ?>">
                                        ...
                                        <textarea class="form-control" placeholder="Input Data......" id="alamat" value="<?= $guru['alamat']; ?>" name="alamat" rows="5"><?= $guru['alamat']; ?></textarea>
