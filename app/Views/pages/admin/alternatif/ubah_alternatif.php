                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group <?= ($validation->hasError('rencana_pelaksanaan_pembelajaran') ? 'has-error has-feedback' : ''); ?>">
                                        ...
                                        <input
                                            type="number"
                                            value="<?= $alternatif['rencana_pelaksanaan_pembelajaran']; ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group <?= ($validation->hasError('kriteria_ketuntasan_minimal') ? 'has-error has-feedback' : ''); ?>">
                                        ...
                                        <input
                                            type="number"
                                            value="<?= $alternatif['kriteria_ketuntasan_minimal']; ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group <?= ($validation->hasError('pembuatan_soal') ? 'has-error has-feedback' : ''); ?>">
                                        ...
                                        <input
                                            type="number"
                                            value="<?= $alternatif['pembuatan_soal']; ?>"
                                            name="pembuatan_soal"
                                            class="form-control"
                                            id="pembuatan_soal"
                                            placeholder="Input data......" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group <?= ($validation->hasError('absensi_kehadiran') ? 'has-error has-feedback' : ''); ?>">
                                        ...
                                        <input
                                            type="number"
                                            value="<?= $alternatif['absensi_kehadiran']; ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group <?= ($validation->hasError('ketepatan_waktu') ? 'has-error has-feedback' : ''); ?>">
                                        ...
                                        <input
                                            type="number"
                                            value="<?= $alternatif['ketepatan_waktu']; ?>"
